...
import com.supereal.bigfile.entity.TestEs;
...
public class TestEsController {
    ...
    public static TestEs tests = null;
    public static List<TestEs> testsList = null;
     ...
     * @throws IOException
     */
    public void add(String index, String type, TestEs tests) throws IOException {
     ...
     * @throws IOException
     */
    public boolean exists(String index, String type, TestEs tests) throws IOException {
     ...
     * @throws IOException
     */
    public void update(String index, String type, TestEs tests) throws IOException {
